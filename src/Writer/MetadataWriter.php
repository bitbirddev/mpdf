...
class MetadataWriter implements \Psr\Log\LoggerAwareInterface
{
    ...
    public function writeMetadata() // _putmetadata
    {
        ...
        $m .= '   <rdf:Description xmlns:pdf="http://ns.adobe.com/pdf/1.3/">' . "\n";
        ...
        $m .= '   <rdf:Description xmlns:xmp="http://ns.adobe.com/xap/1.0/">' . "\n";
        ...
        // DC elements
        $m .= '   <rdf:Description xmlns:dc="http://purl.org/dc/elements/1.1/">' . "\n";
	 ...
	 <rdf:Seq>
	  <rdf:li>' . $this->mpdf->author . '</rdf:li>
        ...
        if ($this->mpdf->PDFX) {
            $m .= '   <rdf:Description xmlns:pdfx="http://ns.adobe.com/pdfx/1.3/" pdfx:Apag_PDFX_Checkup="1.3" pdfx:GTS_PDFXConformance="PDF/X-1a:2003" pdfx:GTS_PDFXVersion="PDF/X-1:2003"/>' . "\n";
        ...
        elseif ($this->mpdf->PDFA) {
            ...
            $m .= '   <rdf:Description xmlns:pdfaid="http://www.aiim.org/pdfa/ns/id/" >' . "\n";
